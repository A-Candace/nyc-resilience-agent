...
def urban_features_page():
    ...
    st.write("**DEBUG: First tract attributes:**")
    st.json(dict(list(boards[0].get("attrs", {}).items())[:30]))
    # END DEBUG CODE
    ...
    # Define field mappings - try multiple possible field names
    field_mappings = {
    ...
    for field in possible_fields:
        # Check if any board has this field
        for b in boards[:5]:  # Check first 5 boards
