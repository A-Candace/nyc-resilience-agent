...
def page_ai_query():
    ...
    if st.button("🔍 Search Tracts", type="primary"):
        ...
        for b in boards:
            ...
            fill_color = [0, 120, 255, 200] if is_match else [200, 200, 200, 100]  # Blue vs Grey
        ...
        if selected_display != "-- Select --":
            ...
            # Use iframe for OSM
            osm_embed = f"""
            <span><span style="color: rgb(150, 34, 73); font-weight: bold;"><iframe></span><span style="color: black; font-weight: normal;"></span><span style="color: rgb(150, 34, 73); font-weight: bold;"></iframe></span><br><br></span>
            <br><span><span style="color: rgb(150, 34, 73); font-weight: bold;"><small></span><span style="color: black; font-weight: normal;">View Larger Map</span><span style="color: rgb(150, 34, 73); font-weight: bold;"></small></span><br><br></span>
            """
            st.markdown(osm_embed, unsafe_allow_html=True)
            
            st.info("💡 **Tip:** Click 'View Larger Map' above to access OSM's full features including 3D buildings, measurement tools, and street view (via integrated services)")
